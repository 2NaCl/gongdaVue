              ...
              <div style="overflow: scroll;white-space:nowrap"  class="treBox">
                <div class="treeCon clearfix">
                    <span>
                      ...
                      <span ><strong>天津工业大学实验室平台</strong></span>
                    </span>
                    <div class="fr">
                      <span class="treeRinfo">
                        <div class="treeRinfo">
                          <span>{{departData.managerId}}</span>
                          <span>在职  <em class="colGreen" title="在职人数">---</em>&nbsp;&nbsp;(<em class="colGreen" title="正式学生">---</em>&nbsp;/&nbsp;<em class="colRed" title="非正式学生">---</em>)</span>
                        </div>
                        <div class="treeRinfo">
                          <el-dropdown class="item">
                            ...
                            <el-dropdown-menu slot="dropdown">
                              ...
                              <el-dropdown-item>
                                <el-button type="text" @click="handleList()">查看待分配学生</el-button>
                              </el-dropdown-item>
                            </el-dropdown-menu>
                          </el-dropdown>
                        </div>
                  ...
                  <el-tree :props="{label:'name'}" :data="depts" node-key="id" default-expand-all>
                    ...
                    <div class="generalClass" slot-scope="{node,data}" style="width:99%">
                        <span>
                           ...
                           <i v-else :class="node.expand?'fa fa-minus-square-o':'fa fa-plus-square-o'"></i>
