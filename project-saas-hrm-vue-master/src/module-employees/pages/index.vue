  ...
  <div class="dashboard-container">
    <div class="app-container">
      <el-card>
        ...
        <div class="fr">
          <router-link :to="{'path':'/employees/import/',query: {name: '学生信息'}}"
          ...
          <el-button type="primary" size="mini" icon="el-icon-plus" @click="handlAdd">新增学生</el-button>
        </div>
      </el-card>
      <el-card shadow="never" class="boxMar">
        <el-table :data="dataList" fit style="width: 100%;" border>
          ...
          <el-table-column sortable prop="workNumber" label="学号"></el-table-column>
          <el-table-column sortable prop="formOfEmployment" label="是否已入实验室"></el-table-column>
          <el-table-column sortable prop="departmentName" label="实验室"></el-table-column>
          <el-table-column sortable prop="timeOfEntry" label="入职时间"></el-table-column>
          <el-table-column sortable label="提权" v-if="level === 'saasAdmin'">
            <template slot-scope="scope">
              <el-button type="primary" plain @click.native="upgradeLevel(scope.row)">提权</el-button>
            </template>
          </el-table-column>
          <el-table-column fixed="right" label="操作" align="center" width="220" v-if="level !== 'user'">
            <template slot-scope="scope">
...
<script>
  ...
  import {list, remove, upgrade} from '@/api/base/users'
